    document.addEventListener('DOMContentLoaded', function() {
      ...
      for(var v in params.views){
        ...
        if(typeof params.views[v].post !== 'function'){
          params.views[v].post = function(callback){
    ...
    const ignoreView = function(viewOrder){
      var _viewOrder = viewOrder || getActiveViewOrder()
...
<div class="row">
  ...
  <div class="col m3 s12" style="min-width:200px">
    <span>
      <a style="margin-top:8px;width:100%" class="waves-effect waves-light btn-large disabled ttb-color-orange" id="wizard_${params.views[index].name}_form_next"><i class="material-icons right" style="margin-right:-22px !important; margin-left:-22px !important">navigate_next</i>Next</a>
    </span>
  </div>
  <div class="col m3 hide-on-small-only"></div>
</div>
...
<div class="row">
  ...
  <div class="col m3 s12" style="min-width:200px">
    <span>
      <a style="margin-top:8px;width:100%" class="waves-effect waves-light btn-large ttb-color-orange" id="wizard_${params.views[index].name}_form_previous"><i class="material-icons left" style="margin-right:-22px !important; margin-left:-22px !important">navigate_before</i>Previous</a>
    </span>
  </div>
  <div class="col m3 s12" style="min-width:200px">
    <span>
      <a style="margin-top:8px;width:100%" class="waves-effect waves-light btn-large ttb-color-orange disabled" id="wizard_${params.views[index].name}_form_next"><i class="material-icons right" style="margin-right:-22px !important; margin-left:-22px !important">navigate_next</i>Next</a>
    </span>
  </div>
  <div class="col m3 hide-on-small-only"></div>
</div>
...
<div class="row">
  ...
  <div class="col m3 s12" style="min-width:200px">
    <span>
      <a style="margin-top:8px;width:100%; color: #454545" class="waves-effect waves-light btn-large disabled ttb-color-green" id="wizard_${params.views[index].name}_form_validate"><i class="material-icons right" style="margin-right:-22px !important; margin-left:-22px !important">send</i>Validate</a>
    </span>
  </div>
  <div class="col m3 hide-on-small-only"></div>
</div>
